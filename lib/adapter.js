...
export class Adapter {
  ...
  async updateContactPoint(id, contactPoint, muHeaders) {
    ...
    console.log('contactgegevenId', JSON.stringify(contactgegevenId, null, 2));
    ...
    this.compareValues(
      ...
      vereniging.vereniging.contactgegevens.find((contactgegeven) => contactgegeven.contactgegevenId === id)
        .contactgegeven,
      {
        email: 'email',
        telephone: 'telefoon',
    ...
    const newContactPoint = this.mapValues(contactPoint, {
      email: 'email',
      telephone: 'telefoon',
      website: 'website',
      type: 'type',
    ...
    // const response = await this.beheersAPIClient.updateContactgegeven(vCode, contactgegevenId, newContactPoint, eTag);
