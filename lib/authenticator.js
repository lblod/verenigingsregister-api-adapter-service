  ...
  async getAccessToken() {
    ...
    if (ENVIRONMENT !== 'PROD') {
      ...
      if (!authorizationKey) {
        ...
        this.setAuthHealthStatus('ERROR', { message: 'AUTHORIZATION_KEY is missing' });
      ...
      return new Promise((resolve, reject) => {
        const req = http.request(url, options, (res) => {
          ...
          res.on('end', () => {
            if (res.statusCode === 200) {
              ...
              this.setAuthHealthStatus('OK');
              resolve(responseJson.access_token);
            } else {
              this.setAuthHealthStatus('ERROR', { statusCode: res.statusCode, body });
        ...
        req.on('error', (error) => {
          ...
          this.setAuthHealthStatus('ERROR', { message: error.message, environment: ENVIRONMENT, host: HOST });
          reject(null);
        });
      ...
      if (keyTest) {
        ...
        this.setAuthHealthStatus('ERROR', { message: 'No signing key found' });
        return null;
      }
    }
  }
